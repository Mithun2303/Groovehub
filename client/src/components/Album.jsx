...
export const Album = ({ props,
    ...
    return (
        <main className="w-[61.34vw] ml-[15.66vw] overflow-x-hidden p-4  text-white">
            <Navbar />
            <section className="w-full h-72 bg-cover bg-center bg-[#2c2a2a]  mt-6 flex items-center gap-12 px-8">
                <div>
            ...
            <section className="mx-16 mt-6 flex gap-12 items-center">
                ...
                {isLoggedIn ? <div className="border-[1px] font-extralight border-white px-2 flex items-center text-center">
                    <span>
                        Follow
                    </span>
                </div> : null}
            </section>
            <section className="mt-12  mx-[5%] w-[90%]">
                <ul className="">
                    {albumDetails.map((element, index) => (
                        <li before={index + 1}
