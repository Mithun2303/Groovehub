...
export const PopularArtist = ({ props,
    setCurrentSong,
    currentSong,
    likedSongs,
    setLikedSongs,
    ...
    return (
        <main className="w-[61.34vw] ml-[15.66vw] overflow-x-hidden p-4  text-white">
            <Navbar />
            <section className="w-full h-72 bg-cover bg-center bg-[#2c2a2a] bg-[url('https://firebasestorage.googleapis.com/v0/b/groovehub-c074d.appspot.com/o/images%2Ftscover.jpeg?alt=media&token=1b0793b8-c8df-46ea-93f6-656ba06feacf')] mt-6 flex items-center gap-12 px-8">
                <div>
                    <img className="min-w-60 max-w-60 min-h-[240px] rounded-[240px]" src={props.cover} alt={props.name} />
                </div>
                <div className="">
                    <span className=" text-7xl  flex flex-wrap font-extrabold w-[500px]  line-clamp-1 text-white mix-blend-overlay">
                        {props.name}
                    </span>
                </div>
            </section>
            <section className="mx-16 mt-6 flex gap-12 items-center">
                ...
                <div className="border-[1px] font-extralight border-white px-2 flex items-center text-center">
                    <span>
                        Follow
                    </span>
                </div>
            ...
            <section className="mt-12  mx-16">
                <ul className="">
                    ...
                    {artistDetails.map((element, index) => (
                        <li before={index + 1}
